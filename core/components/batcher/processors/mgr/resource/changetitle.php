 ...
 */
/**
 * Change title for multiple resources
 *
 * @package batcher
...
if (empty($scriptProperties['title'])) {
    return $modx->error->failure($modx->lexicon('batcher.title_err_ns'));
}

/* iterate over resources */
$pagetitle = $scriptProperties['title'];
...
foreach ($resourceIds as $resourceId) {
    ...
    $resource->set('alias', $aliasGenerator->cleanAlias($pagetitle));
